...
export default function SignInForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirection is handled by login function in AuthContext
    } catch (err: any) {
      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        <div>
          ...
          <div>
            ...
            {error && (
              <div className="mb-4 rounded-lg bg-red-50 p-4 text-sm text-red-500 dark:bg-red-900/30 dark:text-red-400">
                {error}
              </div>
            )}
